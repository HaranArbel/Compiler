...
public class SYMBOL_TABLE
{
	...
	/*we are adding a new "enter" so that each SymbolTable entry will have
	a "context" parameter - which should hold the "offset" info. context 
	class is in AST/metadata directory */
	public void enter(String name,TYPE t, Context context)
	{
		...
		/**************************************************************************/
		SYMBOL_TABLE_ENTRY e = new SYMBOL_TABLE_ENTRY(name,t,hashValue,next,top,top_index++,this.scope_level, context);

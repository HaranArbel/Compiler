...
public class AST_FUNC_DEC_PARAMS extends AST_Node
{
	...
	public TYPE_LIST SemantMe() throws SemantMeException {
		////NEW!!!!
		boolean belong_to_class = AST_DEC_CLASSDEC.fieldsCounter >= 0;

		this.context = new Func_ParamContext(0, belong_to_class);
		AST_FUNC_DEC_PARAMS_LIST.offset = 1;
		...
		this.symbolTable.enter(name, t, context);
